...
coiType = 'none'; % ('fil' - fills the coi with specified color;
...
if strcmpi(loc,'North') || strcmpi(loc,'NorthOutside') || strcmpi(loc,'South')...
    ...
    set(HCB,'xtick',[clim(1):3:clim(2)]); % default(-9:9)
...
%% Contour plot for significant regions
if strcmpi('ordinateType','linear')
    if find(abs(Wxy)==0)
