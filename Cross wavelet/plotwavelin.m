function plotwavelin(Wxy, time, period, coi, sig95, sigmax, sigmay,stringency)
...
% ... Y-axis as period)
sig_level_for_phases = 2; % Added this line so that phases can only be displayed for sig regions - AP
...
% significant regions
CData_sig = CData;
CData_sig(sig95 < 2*stringency)=nan;
aWxy=angle(CData_sig);
